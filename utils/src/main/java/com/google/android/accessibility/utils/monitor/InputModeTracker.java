...
/** Tracks input mode which user is currently using to interact with the service. */
public class InputModeTracker implements ServiceKeyEventListener {
  ...
  public static final int INPUT_MODE_BRAILLE_KEYBOARD = 5;
  ...
  // changes are done only inside this class, and setInputMode becomes a private method.
  ...
  public static String inputModeToString(@InputMode int inputMode) {
    switch (inputMode) {
      ...
      case INPUT_MODE_BRAILLE_KEYBOARD:
        return "INPUT_MODE_BRAILLE_KEYBOARD";
