...
public class ClickableHintForXR extends ClickableHint {

  private static final String TAG = "ClickableHintForXR";

  public ClickableHintForXR(Context context, GlobalVariables globalVariables) {
  ...
  protected CharSequence getTapGestureHint() {
    return globalVariables.useSingleTap()
        ? context.getString(R.string.value_single_tap_xr)
        : context.getString(R.string.value_double_tap_xr);
  }
}
