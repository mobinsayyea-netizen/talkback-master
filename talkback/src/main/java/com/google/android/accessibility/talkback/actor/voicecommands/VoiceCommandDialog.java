...
public class VoiceCommandDialog extends FirstTimeUseDialog {

  private final Pipeline.FeedbackReturner pipeline;

  public VoiceCommandDialog(Context context, Pipeline.FeedbackReturner pipeline) {
    super(
        context,
  ...
  public View getCustomizedView(LayoutInflater inflater) {
    setMainMessage(
        context.getString(
            (R.string.dialog_message_voice_commands), context.getString(R.string.title_pref_help)));
    return super.getCustomizedView(inflater);
  }
}
