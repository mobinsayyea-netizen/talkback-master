...
public class ProximitySensorMonitor implements ScreenChangedListener {
  ...
  public ProximitySensorMonitor(
      TalkBackService service, ProximitySensor.ProximityChangeListener proximityChangeListener) {
