...
public abstract class Request {
  ...
  public static String errorName(@ErrorCode int errorCode) {
    return switch (errorCode) {
      ...
      case ERROR_NETWORK_ERROR -> "ERROR_NETWORK_ERROR";
      case ERROR_INSUFFICIENT_STORAGE -> "ERROR_INSUFFICIENT_STORAGE";
      case ERROR_TEXT_RECOGNITION_NO_RESULT -> "ERROR_TEXT_RECOGNITION_NO_RESULT";
      case ERROR_ICON_DETECTION_NO_RESULT -> "ERROR_ICON_DETECTION_NO_RESULT";
      case ERROR_IMAGE_DESCRIPTION_NO_RESULT -> "ERROR_IMAGE_DESCRIPTION_NO_RESULT";
      case ERROR_IMAGE_DESCRIPTION_FAILURE -> "ERROR_IMAGE_DESCRIPTION_FAILURE";
