...
/**
 * Event feedback rule for {@link EVENT_SYNTHESIZE_SPEECH}. These rules will provide the event
 ...
 * feature.
 */
public final class SynthesizeSpeechFeedbackRule {

  private static final String TAG = "SynthesizeSpeechFeedbackRule";
  ...
  public static void addFeedbackRule(
    ...
    eventFeedbackRules.put(
        ...
        (eventOptions) -> {
          ...
          LogUtils.v(TAG, " ttsOutputRule= nodeRoleDescriptionText: " + ttsOutput);

          return EventFeedback.builder().setTtsOutput(Optional.of(ttsOutput)).build();
        });
  }

  private SynthesizeSpeechFeedbackRule() {}
}
