...
/** Rule for generating menu item related to Spannable links. */
public class LinkMenu implements NodeMenu {

  private static final String TAG = "LinkMenu";
  private final TalkBackAnalytics analytics;

  public LinkMenu(TalkBackAnalytics analytics) {
  ...
  public List<ContextMenuItem> getMenuItemsForNode(
    ...
    for (SpannableWithOffset spannableWithOffset : spannableStrings) {
      ...
      Spannable spannable = spannableWithOffset.spannableString;
      ...
      for (int i = 0; i < spans.length; i++) {
        ...
        if (span instanceof URLSpan) {
          if (TalkbackFeatureSupport.skipURLSpanClick()) {
            continue;
          }
  ...
  private static class UrlSpanMenuItemClickListener implements OnContextMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
      if (context == null || TalkbackFeatureSupport.skipURLSpanClick()) {
        return false;
      }
