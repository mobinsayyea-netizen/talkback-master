...
public class LongClickableHintForXR extends LongClickableHint {

  private static final String TAG = "LongClickableHintForXR";

  public LongClickableHintForXR(Context context, GlobalVariables globalVariables) {
    super(context, globalVariables);
  }

  @Override
  protected CharSequence getLongClickGestureHint() {
    return context.getString(R.string.value_single_tap_xr);
  }
}
