...
public class AccessibilitySliderPreference extends SeekBarPreference {

  public AccessibilitySliderPreference(@NonNull Context context) {
    super(context);
  }

  public AccessibilitySliderPreference(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
  }
