...
public class TutorialView extends FrameLayout implements OrientationSensitive {
  ...
  class TypeLetterA implements TutorialState {
    ...
    @Override
    public String audialAnnouncement() {
      return getResources().getString(R.string.type_letter_a_announcement);
    }

    @Override
    public String audialAnnouncementRepeated() {
      return getResources().getString(R.string.type_letter_a_inactive_announcement);
    }

    @Override
    public String hintText() {
      return getResources().getString(R.string.instruction_type_letter_a);
    }
  ...
  class SwipeUp implements TutorialState {
    private boolean actionCompleted;

    @Override
    public State getCurrentState() {
      return State.SWIPE_UP;
    }
    ...
    public void loadView() {
      addView(inputView);
      tutorialAnimationView.reset();
      tutorialAnimationView.startSwipeAnimation(1, BOTTOM_TO_TOP);
      tutorialAnimationView.startHintToastAnimation(state.hintText());
      addView(tutorialAnimationView);
      speakAnnouncement(audialAnnouncement(), /* delayMs= */ 0);
    }
    ...
    @Override
    public String audialAnnouncement() {
      return getResources().getString(R.string.swipe_up_announcement);
    }
    ...
    @Override
    public String hintText() {
      return getResources().getString(R.string.instruction_swipe_up);
    }

    @Override
    public String resultText() {
      return getResources().getString(R.string.result_swipe_up);
    }
  ...
  class SwipeDown implements TutorialState {
    private boolean actionCompleted;

    @Override
    public State getCurrentState() {
      return State.SWIPE_DOWN;
    }
    ...
    public void loadView() {
      addView(inputView);
      tutorialAnimationView.reset();
      tutorialAnimationView.startSwipeAnimation(1, TOP_TO_BOTTOM);
      tutorialAnimationView.startHintToastAnimation(state.hintText());
      addView(tutorialAnimationView);
      speakAnnouncement(audialAnnouncement(), /* delayMs= */ 0);
    }
    ...
    @Override
    public String audialAnnouncement() {
      return getResources().getString(R.string.swipe_down_announcement);
    }
    ...
    @Override
    public String hintText() {
      return getResources().getString(R.string.instruction_swipe_down);
    }

    @Override
    public String resultText() {
      return getResources().getString(R.string.result_swipe_down);
    }
  ...
  public TutorialView(Context context, TutorialCallback tutorialCallback, Size screenSize) {
    super(context);
  ...
  private void speakBrailleCharacter(BrailleCharacter brailleCharacter, int delayMs) {
    String textToSpeak =
        BrailleTranslateUtilsUeb.getTextToSpeak(TutorialView.this.getResources(), brailleCharacter);
